...
dataentery_frame_bg = 'Yellow'
buttons_frame_bg = 'Orange'
hlb_btn_bg = 'YellowGreen'
...
Label(root, text='KLH EXPENSE TRACKER', font=('Noto Sans CJK TC', 15, 'bold'), bg=hlb_btn_bg).pack(side=TOP, fill=X)
